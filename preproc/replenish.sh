...
do
    ...
    do
        ...
        3dmaskdump -xyz -mask work/code/fs125/atlas_mask/Lausanne2008/ROI_scale33/8.nii.gz /work/code/fs125/$subject/tfMRI/tfMRI_LANGUAGE_125mm_$phase.nii.gz > $output_dir/8.txt
